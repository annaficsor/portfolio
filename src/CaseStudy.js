  ...
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        <div className="row title align-items-center">
          <Fade bottom spy={study} appear>
            <div className="col title casename bodycopy text-center text-light my-5 px-5">
              ...
              {study.github && (
                <div>
                <a href={study.github} target="_blank" rel="noopener noreferrer"><button className="mb-3 case">View repo on GitHub &#62;&#62; </button></a>
                <a href={study.site} target="_blank" rel="noopener noreferrer"><button className="mb-4 case">Visit website &#62;&#62; </button></a>
                </div>
              )}
            ...
            <div className="col px-0">
              {study.linkname ==="optics" && (
                <div className="opticspic pt-4" style={{backgroundColor: study.color2}}>
                  <img className="caseimage mx-auto img-fluid"srcSet={`${study.desktop.first} 1x, ${study.desktop.second} 2x, ${study.desktop.third} 3x`} src={study.desktop.third} alt="desktop view"/>
                </div>
              )}
              {study.linkname !=="optics" && (
        ...
        <div className="row title align-items-center">
          <Fade bottom spy={study} appear delay={100}>
            ...
            <div className="row title text-center">
              <div className="col px-0">
                <div className="desktoppic pt-4" style={{backgroundColor: study.color2}}>
                  <img className="caseimage mx-auto img-fluid"srcSet={`${study.phone.first} 1x, ${study.phone.second} 2x, ${study.phone.third} 3x`} src={study.phone.third} alt="phone view"/>
                </div>
              </div>
            </div>
          )}
